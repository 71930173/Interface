...
<div class="wrap">
  <div class="en">
    ...
    <h2>✅ Smart Queue — Appointment Confirmed</h2>
    ...
    <p class="footer">Smart Queue System</p>
  </div>
  <div class="ar">
    <div class="label">العربية</div>
    <h2>✅ Smart Queue — تم تأكيد الموعد</h2>
    ...
    <p class="footer">نظام Smart Queue</p>
  </div>
</div></body></html>`;
...
`✅ *Smart Queue — Appointment Confirmed / تم تأكيد الموعد*
...
`⏰ *Smart Queue — 3 Minutes Left / تبقى 3 دقائق*
                      ...
                      recalculateQueue(staff_id, (err) => {
                        ...
                        db.query(
                          ...
                          (err, positionResults) => {
                            ...
                            db.query(
                              'SELECT email, phone, first_name, last_name FROM students WHERE id = ?',
                              [req.studentId],
                              async (err, results) => {
