...
app.use('/api/parent/', parentLimiter);
...
app.listen(PORT, () => {
  console.log('=================================');
  console.log('🚀 Smart Queue API Server v2.0');
  console.log('=================================');
  console.log(`📡 Server running on http://0.0.0.0:${PORT}`);
  console.log(`🔧 Environment: ${process.env.NODE_ENV || 'development'}`);
  console.log(`📊 Health check: http://0.0.0.0:${PORT}/health`);
  console.log('=================================');
  console.log('Features: Parent Priority, Real-time Queue, SMS/Email/WhatsApp Notifications');
  console.log('=================================');
});
