  ...
  return (
    <div className="page-container">
      <div className="content-container">
        ...
        <h1 className="text-2xl font-bold text-dark-900 mb-6">{lang === 'ar' ? 'مواعيدي' : 'My Appointments'}</h1>
        <EmptyState icon={Calendar} title={lang === 'ar' ? 'لا توجد مواعيد' : 'No Appointments'} />
      </div>
    </div>
  );
};
